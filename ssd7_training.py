...
model_path = r'C:\Users\Anirudh\Desktop\ssd_keras-master\GR\data\GR_weights.h5'
...
# Images
images_dir_train= r'C:\Users\Anirudh\Desktop\ssd_keras-master\GR\data\train'
images_dir_val=r'C:\Users\Anirudh\Desktop\ssd_keras-master\GR\data\val'
# Ground truth
train_labels_filename = r'C:\Users\Anirudh\Desktop\ssd_keras-master\GR\data\train_data.csv'
val_labels_filename   = r'C:\Users\Anirudh\Desktop\ssd_keras-master\GR\data\val_data.csv'

train_dataset.parse_csv(images_dir=r'C:\Users\Anirudh\Desktop\ssd_keras-master\GR\data\train',
...
val_dataset.parse_csv(images_dir=r'C:\Users\Anirudh\Desktop\ssd_keras-master\GR\data\val',
...
predictor_sizes = [model[0].get_layer('classes4').output_shape[1:3],
                   model[0].get_layer('classes5').output_shape[1:3],
                   model[0].get_layer('classes6').output_shape[1:3],
                   model[0].get_layer('classes7').output_shape[1:3]]
...
model_checkpoint = ModelCheckpoint(filepath=r'C:\Users\Anirudh\Desktop\ssd_keras-master\GR\data\GR_weights.h5',
                                   monitor='val_loss',
                                   verbose=1,
                                   save_best_only=True,
